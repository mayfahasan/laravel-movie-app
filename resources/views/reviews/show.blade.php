        ...
        <div class="flex flex-col gap-10">
            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div class="grid grid-cols-7 border-t border-stroke px-4 py-4.5 dark:border-strokedark sm:grid-cols-9 md:px-6 2xl:px-7.5">
                    ...
                    <div class="col-span-2 flex items-center">
                        <div class="flex items-center gap-3">
                            <img src="src/images/user/{{ strtolower($review['user']) }}.png" alt="{{ $review['user'] }}'s avatar" class="w-10 h-10 rounded-full object-cover" />
                            <p class="text-sm font-medium text-black dark:text-white">
                                {{ $review['user'] }}
                            </p>
                        </div>
                    ...
                    <div class="col-span-1 flex items-center">
                        <div class="flex items-center space-x-1">
                            <a href="{{ url('reviews/edit/'.$review['id']) }}" class="inline-flex items-center rounded-md bg-yellow-50 px-2 py-1 text-xs font-medium text-yellow-800 ring-1 ring-inset ring-yellow-600/20">Edit</a>
